    ...
    <div className="min-h-[70vh] flex items-center justify-center bg-bg-off-white py-16 px-6">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-card shadow-[0_20px_40px_rgba(0,0,0,0.08)] p-10">
          ...
          {/* Sliquid employee SSO */}
          <a
            href={`${PORTAL_URL}/employee-login`}
            className="w-full flex items-center justify-center gap-2 border border-sliquid-blue text-sliquid-blue
                       hover:bg-bg-light-blue font-semibold py-3 rounded-lg text-sm transition-colors duration-150"
          >
